...
export function* signUpUser ({ payload: {
    ...
    try{
        ...
        const additionalDate = { displayName }
        yield getSnapshotFromUserAuth(user, additionalDate)
        // yield call(handleUserProfile,  {userAuth: user, additionalDate:{ displayName } })
